...
document.querySelector(".checkout-btn").addEventListener("click", () => {
    ...
    let totalEl = document.querySelector(".total-price"); // element that shows total price
    let cartItemsEl = document.querySelector(".cart-items"); // container for cart items
